...
class ParkingData(models.Model):
    ...
    country_code = models.CharField(max_length=10, blank=True, null=True, unique=False)
    province = models.CharField(max_length=255, blank=True, null=True, unique=False)
    city = models.CharField(max_length=255, blank=True, null=True, unique=False)
